...
class NinechangVdo2Controller extends Controller
{
    ...
    {
        try {   
            $getAllVdoOriginal = NinechangVdo2Service::getAllVdo();
            ...
            $data = [
                ...
                'page_name' => 'Ninechang/vdo2',
                'side_name' => 'ninechang',
                'page_name_th' => 'หน้าหลัก',
			    'page_name_th_url' => '/ninechang',
                'page_name_v1' => 'vdo2',
                'page_name_v1_url' => '/ninechang/vdo/2',
                'page_name_v2' => null,
                'page_name_v2_url' => null,
                'vdoshowup' => $getAllVdoOriginal
            ];
            return view('pages.ninechang.ninechang-vdo-2')->with($data);
        } catch (\Throwable $th) {
            throw $th;
        }
    }
    ...
    public function create(Request $request){
        try { 
            ...
            $result = NinechangVdo2Service::create($request);
    ...
    public function destroy(Request $request, $id){
        try {
            $result = NinechangVdo2Service::destroy($id);
