...
<div class="my-profile-box">
    ...
    <form id="frm-ad2" method="post" class="needs-validation" novalidate>
        @csrf
...
@section('js-content')
    <script src="{{ asset('assets/js-external/findchang/findchang-ad-2.js') }}"></script>
@endsection
