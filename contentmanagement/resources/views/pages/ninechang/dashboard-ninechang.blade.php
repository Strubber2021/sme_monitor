...
@section('content')
    <div class="dashboard-fun-fact-area">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="stats-fun-fact-box">
                    <a href="/ninechang/counter/download">
                        <div class="icon-box">
