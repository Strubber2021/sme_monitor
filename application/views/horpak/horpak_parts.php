            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                      <h4 class="card-title">รายการข้อมูลอะไหล่/อุปกรณ์ซ่อม: โปรแกรมหอพัก</h4>
                    </div>
                    <div class="card-body">
                        <div class="basic-form">
							<form action="<?php echo base_url('horpak/parts/');?>" method="POST">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
							<table id="example4" class="happyTable display table table-hover table-responsive-sm" style="min-width: 845px">
                                ...
                                <tbody>							
                                    <?php if(!empty($result_repair)){
                                    foreach($result_repair as $key => $row){ ?>
                                    <tr class="text-black">
