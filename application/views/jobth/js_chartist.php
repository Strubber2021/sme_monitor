		...
		if(jQuery('#regis_week').length > 0 ){
			...
			let barChartData = {
				...
				datasets: [{
					...
					data: [<?php foreach($regis_week['employers'] as $value){echo "'".$value."'".',';}?>]
				}, {
					label: 'บุคคลหางาน',
					backgroundColor: barChart_3gradientStroke2,
					hoverBackgroundColor: barChart_3gradientStroke2, 
					data: [<?php foreach($regis_week['users'] as $value){echo "'".$value."'".',';}?>]
				}]
		...
		if(jQuery('#regis_previous').length > 0 ){
			...
			let barChartData = {
				...
				datasets: [{
					...
					backgroundColor: barChart_3gradientStroke,
					hoverBackgroundColor: barChart_3gradientStroke, 
					data: [<?php foreach($regis_previous['employers'] as $value){echo "'".$value."'".',';}?>]
				}, {
					label: 'บุคคลหางาน',
					backgroundColor: barChart_3gradientStroke2,
					hoverBackgroundColor: barChart_3gradientStroke2, 
					data: [<?php foreach($regis_previous['users'] as $value){echo "'".$value."'".',';}?>]
				}]
		...
		if(jQuery('#regis_previous2').length > 0 ){
			...
			let barChartData = {
				...
				datasets: [{
					...
					backgroundColor: barChart_3gradientStroke,
					hoverBackgroundColor: barChart_3gradientStroke, 
					data: [<?php foreach($regis_previous2['employers'] as $value){echo "'".$value."'".',';}?>]
				}, {
					label: 'บุคคลหางาน',
					backgroundColor: barChart_3gradientStroke2,
					hoverBackgroundColor: barChart_3gradientStroke2, 
					data: [<?php foreach($regis_previous2['users'] as $value){echo "'".$value."'".',';}?>]
				}]
		...
		if(jQuery('#CommentAllChart').length > 0 ){
			...
			let barChartData = {
				...
				datasets: [{
					...
					backgroundColor: barChart_3gradientStroke,
					hoverBackgroundColor: barChart_3gradientStroke, 
					data: [<?php foreach($month_employers as $value){echo "'".$value."'".',';}?>]
				}, {
					label: 'บุคคลหางาน',
					backgroundColor: barChart_3gradientStroke2,
					hoverBackgroundColor: barChart_3gradientStroke2, 
					data: [<?php	foreach($month_users as $value){echo "'".$value."'".',';}?>]
				}]
			};
			...
			new Chart(barChartMonth, {
				...
				data: {
					...
					datasets: [
						{
							label: "คำแนะนำ/ติชม",
							data: 	[<?php foreach ($month_review_all as $value) {	echo $value.',';}?>],
