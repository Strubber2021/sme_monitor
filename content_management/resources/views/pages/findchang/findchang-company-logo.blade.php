...
<div class="my-profile-box">
    ...
    <form id="frm-company" method="post" class="needs-validation" novalidate>
        @csrf
        <div class="profile-outer-area">
            <div class="profile-outer">
                <div class="profileButton">
                    <input class="profileButton-input" type="file" name="attachments" onchange="previewFile()" accept="image/*" id="upload" required multiple/>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-xl-6 col-lg-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="short_name" placeholder="" required>
                </div>
            </div>
        </div>
        <div class="row align-items-center">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="blog-card">
                        <div class="blog-img" style="hw">
                            <a href="#">
                                <img src="{{ asset($item->image_path) }}" alt="Blog Images" title="{{ $item->company_name }} ( {{ $item->short_name }} )" alt="" onerror="this.onerror=null;this.src='{{ asset('assets/images/empty-logo.png') }}';">
                            </a>
...
@section('js-content')
    <script src="{{ asset('assets/js-external/findchang/findchang-company-logo.js') }}"></script>
@endsection
