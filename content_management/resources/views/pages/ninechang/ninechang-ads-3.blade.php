...
<div class="my-profile-box">
    ...
    <form id="frm-ad3" method="post" class="needs-validation" novalidate>
        @csrf
...
@section('js-content')
    <script src="{{ asset('assets/js-external/ninechang/ninechang-ad-3.js') }}"></script>
@endsection
