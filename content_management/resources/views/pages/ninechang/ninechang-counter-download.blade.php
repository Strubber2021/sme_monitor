        ...
        <div class="row align-items-center">
            <div class="col-xl-6 col-lg-12 col-md-12">
                <div class="form-group">
                    <label>ระบุยอดจำนวนดาวน์โหลด <span class="text-danger">*</span> </label>
            ...
            <div class="col-xl-6 col-lg-12 col-md-12">
                <div class="form-group">
                    ...
                    <h3><span class="counter-custom">{{ number_format($counter != null ? $counter->counter : 0,0) }}</span></h3>
                        ...
                        <p style="margin-bottom: 0; margin-top: 10px;">ยอดดาวน์โหลด Download</p></div>
                </div>
            </div>
        </div>
        <div class="row align-items-center">
...
@section('js-content')
    <script src="{{ asset('assets/js-external/ninechang/ninechang-counter-download.js') }}"></script>
@endsection
